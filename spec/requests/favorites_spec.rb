...
RSpec.describe "Favorites", type: :request do
  let!(:user) { User.create!(username: "", email: "test@example.com") }
  ...
  describe "GET /favorites" do
    it "returns a successful response and lists all favorites" do
      get favorites_path
  ...
  describe "GET /favorites/:id" do
    it "returns a successful response and shows the favorite" do
    ...
    it "returns 404 if favorite does not exist" do
